...
$$
下面对$\mathbb{P}(\mathcal{S})$进行估计: 简单起见, 我们估计$\{x_1, x_2, \cdots, x_{d-1}\}$出现的次数$C_m$. 设$p= 8\varepsilon$. 利用[[Lecture 3. Bernstein's Type Inequality#3. Bernstein's Inequality (Variance Version)]]
$$
